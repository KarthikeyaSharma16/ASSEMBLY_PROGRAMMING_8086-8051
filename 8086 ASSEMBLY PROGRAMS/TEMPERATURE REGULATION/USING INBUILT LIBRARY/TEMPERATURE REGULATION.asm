;KARTHIKEYA SHARMA
; This program illustrates to maintain a constant temperature using heater and thermometer 
; (between 60C to 80C),it is assumed that air temperature is lower 60C.
